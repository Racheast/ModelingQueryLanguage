 ...
 * <ul>
 *   <li>{@link qmm.RoleClassLib#validate(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate</em>}</li>
 * </ul>
 * </p>
 * @generated
 */
public class RoleClassLibTest extends CAEXObjectTest {
	...
	protected void setUp() throws Exception {
		setFixture(QmmFactory.eINSTANCE.createRoleClassLib());
	}
	...
	/**
	 * Tests the '{@link qmm.RoleClassLib#validate(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see qmm.RoleClassLib#validate(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
