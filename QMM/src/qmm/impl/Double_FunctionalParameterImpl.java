...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Double Functional Parameter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link qmm.impl.Double_FunctionalParameterImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Double_FunctionalParameterImpl extends Double_TypeImpl implements Double_FunctionalParameter {
	/**
	 ...
	 * @generated
	 */
	protected Double_FunctionalParameterImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return QmmPackage.eINSTANCE.getDouble_FunctionalParameter();
	}
	...
	public NotificationChain basicSetArgument(FunctionalArgument newArgument, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QmmPackage.DOUBLE_FUNCTIONAL_PARAMETER__ARGUMENT, oldArgument, newArgument);
	...
	public void setArgument(FunctionalArgument newArgument) {
		if (newArgument != argument) {
			...
			if (argument != null)
				msgs = ((InternalEObject)argument).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QmmPackage.DOUBLE_FUNCTIONAL_PARAMETER__ARGUMENT, null, msgs);
			if (newArgument != null)
				msgs = ((InternalEObject)newArgument).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QmmPackage.DOUBLE_FUNCTIONAL_PARAMETER__ARGUMENT, null, msgs);
			msgs = basicSetArgument(newArgument, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QmmPackage.DOUBLE_FUNCTIONAL_PARAMETER__ARGUMENT, newArgument, newArgument));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QmmPackage.DOUBLE_FUNCTIONAL_PARAMETER__ARGUMENT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == FunctionalParameter.class) {
			switch (derivedFeatureID) {
				case QmmPackage.DOUBLE_FUNCTIONAL_PARAMETER__ARGUMENT: return QmmPackage.FUNCTIONAL_PARAMETER__ARGUMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == FunctionalParameter.class) {
			switch (baseFeatureID) {
				case QmmPackage.FUNCTIONAL_PARAMETER__ARGUMENT: return QmmPackage.DOUBLE_FUNCTIONAL_PARAMETER__ARGUMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			switch (baseOperationID) {
				case QmmPackage.TYPED_ELEMENT___GET_TYPE: return QmmPackage.DOUBLE_FUNCTIONAL_PARAMETER___GET_TYPE;
				default: return -1;
			}
		}
		if (baseClass == Parameter.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case QmmPackage.DOUBLE_FUNCTIONAL_PARAMETER___VALIDATE__DIAGNOSTICCHAIN_MAP:
				return validate((DiagnosticChain)arguments.get(0), (Map)arguments.get(1));
			case QmmPackage.DOUBLE_FUNCTIONAL_PARAMETER___GET_TYPE:
				return getType();
		}
		return super.eInvoke(operationID, arguments);
	}

} //Double_FunctionalParameterImpl
