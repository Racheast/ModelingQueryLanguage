...
public class VersionImpl extends RootClassImpl implements Version {
	 ...
	 * @ordered
	 */
	protected Version_value_AttrEClass value_AttrEClass;
	 ...
	 * @generated
	 */
	public Version_value_AttrEClass getValue_AttrEClass() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetValue_AttrEClass(Version_value_AttrEClass newValue_AttrEClass, NotificationChain msgs) {
		Version_value_AttrEClass oldValue_AttrEClass = value_AttrEClass;
		value_AttrEClass = newValue_AttrEClass;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, QmmPackage.VERSION__VALUE_ATTR_ECLASS, oldValue_AttrEClass, newValue_AttrEClass);
	 ...
	 * @generated
	 */
	public void setValue_AttrEClass(Version_value_AttrEClass newValue_AttrEClass) {
		if (newValue_AttrEClass != value_AttrEClass) {
			NotificationChain msgs = null;
			if (value_AttrEClass != null)
				msgs = ((InternalEObject)value_AttrEClass).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - QmmPackage.VERSION__VALUE_ATTR_ECLASS, null, msgs);
			if (newValue_AttrEClass != null)
				msgs = ((InternalEObject)newValue_AttrEClass).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - QmmPackage.VERSION__VALUE_ATTR_ECLASS, null, msgs);
			msgs = basicSetValue_AttrEClass(newValue_AttrEClass, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QmmPackage.VERSION__VALUE_ATTR_ECLASS, newValue_AttrEClass, newValue_AttrEClass));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case QmmPackage.VERSION__VALUE_ATTR_ECLASS:
				setValue_AttrEClass((Version_value_AttrEClass)newValue);
				return;
			case QmmPackage.VERSION__CHANGE_MODE_ATTR_ECLASS:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case QmmPackage.VERSION__VALUE_ATTR_ECLASS:
				setValue_AttrEClass((Version_value_AttrEClass)null);
				return;
			case QmmPackage.VERSION__CHANGE_MODE_ATTR_ECLASS:
