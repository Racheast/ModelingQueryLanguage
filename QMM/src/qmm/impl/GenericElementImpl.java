...
public class GenericElementImpl extends ElementImpl implements GenericElement {
	...
	public EList<GenericElement_OrGroup> getNestedElements() {
		if (nestedElements == null) {
			nestedElements = new EObjectContainmentEList<GenericElement_OrGroup>(GenericElement_OrGroup.class, this, QmmPackage.GENERIC_ELEMENT__NESTED_ELEMENTS);
		}
	...
	public EList<GenericAttribute_OrGroup> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<GenericAttribute_OrGroup>(GenericAttribute_OrGroup.class, this, QmmPackage.GENERIC_ELEMENT__ATTRIBUTES);
		}
		return attributes;
	}
