...
/**
 * This is the item provider adapter for a {@link qmm.AttributeEClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeEClassItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AttributeEClassItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AttributeEClass)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AttributeEClass_type") :
			getString("_UI_AttributeEClass_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AttributeEClass.class)) {
