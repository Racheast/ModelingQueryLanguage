...
import qmm.String_AttributeEClass;

/**
 * This is the item provider adapter for a {@link qmm.String_AttributeEClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class String_AttributeEClassItemProvider extends RegularAttributeEClassItemProvider {
	/**
	 ...
	 * @generated
	 */
	public String_AttributeEClassItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QmmPackage.eINSTANCE.getString_AttributeEClass_Operator());
		}
	...
	public String getText(Object object) {
		String label = ((String_AttributeEClass)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_String_AttributeEClass_type") :
			getString("_UI_String_AttributeEClass_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(String_AttributeEClass.class)) {
			case QmmPackage.STRING_ATTRIBUTE_ECLASS__OPERATOR:
