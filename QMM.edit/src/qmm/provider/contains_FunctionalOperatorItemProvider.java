...
/**
 * This is the item provider adapter for a {@link qmm.contains_FunctionalOperator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class contains_FunctionalOperatorItemProvider extends String_Original_FunctionalOperatorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public contains_FunctionalOperatorItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QmmPackage.eINSTANCE.getcontains_FunctionalOperator_CharSequence());
		}
	...
	/**
	 * This returns contains_FunctionalOperator.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/contains_FunctionalOperator"));
	}
	...
	public String getText(Object object) {
		contains_FunctionalOperator contains_FunctionalOperator = (contains_FunctionalOperator)object;
		return getString("_UI_contains_FunctionalOperator_type") + " " + contains_FunctionalOperator.isNegated();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(contains_FunctionalOperator.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getcontains_FunctionalOperator_CharSequence(),
				 QmmFactory.eINSTANCE.createCharSequence_FunctionalParameter()));
	}
