...
/**
 * This is the item provider adapter for a {@link qmm.Integer_BitOperator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Integer_BitOperatorItemProvider extends Integer_ExpressionOperatorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public Integer_BitOperatorItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QmmPackage.eINSTANCE.getInteger_BitOperator_Connects());
		}
	...
	public String getText(Object object) {
		Integer_BitOperator integer_BitOperator = (Integer_BitOperator)object;
		return getString("_UI_Integer_BitOperator_type") + " " + integer_BitOperator.isNegated();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Integer_BitOperator.class)) {
