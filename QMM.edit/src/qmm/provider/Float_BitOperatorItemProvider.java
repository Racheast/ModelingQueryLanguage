...
/**
 * This is the item provider adapter for a {@link qmm.Float_BitOperator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Float_BitOperatorItemProvider extends Float_ExpressionOperatorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public Float_BitOperatorItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QmmPackage.eINSTANCE.getFloat_BitOperator_Connects());
		}
	...
	public String getText(Object object) {
		Float_BitOperator float_BitOperator = (Float_BitOperator)object;
		return getString("_UI_Float_BitOperator_type") + " " + float_BitOperator.isNegated();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Float_BitOperator.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getFloat_BitOperator_Connects(),
				 QmmFactory.eINSTANCE.createFloat_And_BitOperator()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getFloat_BitOperator_Connects(),
				 QmmFactory.eINSTANCE.createFloat_Or_BitOperator()));
