...
/**
 * This is the item provider adapter for a {@link qmm.Number_BitOperator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Number_BitOperatorItemProvider extends Number_ExpressionOperatorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public Number_BitOperatorItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QmmPackage.eINSTANCE.getNumber_BitOperator_Connects());
		}
	...
	public String getText(Object object) {
		Number_BitOperator number_BitOperator = (Number_BitOperator)object;
		return getString("_UI_Number_BitOperator_type") + " " + number_BitOperator.isNegated();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Number_BitOperator.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getNumber_BitOperator_Connects(),
				 QmmFactory.eINSTANCE.createNumber_And_BitOperator()));
