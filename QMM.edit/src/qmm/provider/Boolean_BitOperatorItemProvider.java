...
/**
 * This is the item provider adapter for a {@link qmm.Boolean_BitOperator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Boolean_BitOperatorItemProvider extends Boolean_ExpressionOperatorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public Boolean_BitOperatorItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QmmPackage.eINSTANCE.getBoolean_BitOperator_Connects());
		}
	...
	public String getText(Object object) {
		Boolean_BitOperator boolean_BitOperator = (Boolean_BitOperator)object;
		return getString("_UI_Boolean_BitOperator_type") + " " + boolean_BitOperator.isNegated();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Boolean_BitOperator.class)) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getBoolean_BitOperator_Connects(),
				 QmmFactory.eINSTANCE.createBoolean_And_BitOperator()));
