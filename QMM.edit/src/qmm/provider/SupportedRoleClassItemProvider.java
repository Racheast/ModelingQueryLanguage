...
/**
 * This is the item provider adapter for a {@link qmm.SupportedRoleClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SupportedRoleClassItemProvider extends CAEXBasicObjectItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QmmPackage.eINSTANCE.getSupportedRoleClass_MappingObject());
			childrenFeatures.add(QmmPackage.eINSTANCE.getSupportedRoleClass_RoleClass());
			childrenFeatures.add(QmmPackage.eINSTANCE.getSupportedRoleClass_RefRoleClassPath_AttrEClass());
		}
	...
	public String getText(Object object) {
		return getString("_UI_SupportedRoleClass_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getSupportedRoleClass_MappingObject(),
				 QmmFactory.eINSTANCE.createMapping_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getSupportedRoleClass_RoleClass(),
				 QmmFactory.eINSTANCE.createRoleClass_OrGroup()));

		newChildDescriptors.add
			(createChildParameter
				(QmmPackage.eINSTANCE.getSupportedRoleClass_RefRoleClassPath_AttrEClass(),
				 QmmFactory.eINSTANCE.createSupportedRoleClass_refRoleClassPath_AttrEClass()));
	}
