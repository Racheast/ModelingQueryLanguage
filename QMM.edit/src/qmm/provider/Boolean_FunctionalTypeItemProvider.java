...
/**
 * This is the item provider adapter for a {@link qmm.Boolean_FunctionalType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Boolean_FunctionalTypeItemProvider extends Boolean_TypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public Boolean_FunctionalTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		Boolean_FunctionalType boolean_FunctionalType = (Boolean_FunctionalType)object;
		return getString("_UI_Boolean_FunctionalType_type") + " " + boolean_FunctionalType.isNegated();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Boolean_FunctionalType.class)) {
			case QmmPackage.BOOLEAN_FUNCTIONAL_TYPE__NEGATED:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case QmmPackage.BOOLEAN_FUNCTIONAL_TYPE__OPERATOR:
