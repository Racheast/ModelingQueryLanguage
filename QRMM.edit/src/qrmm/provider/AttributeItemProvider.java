...
/**
 * This is the item provider adapter for a {@link qrmm.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider extends CAEXObjectItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.ATTRIBUTE__DEFAULT_VALUE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.ATTRIBUTE__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.ATTRIBUTE__ATTRIBUTE_DATA_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.ATTRIBUTE__REF_ATTRIBUTE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.ATTRIBUTE__UNIT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QrmmPackage.Literals.ATTRIBUTE__REF_SEMANTIC);
			childrenFeatures.add(QrmmPackage.Literals.ATTRIBUTE__CONSTRAINT);
			childrenFeatures.add(QrmmPackage.Literals.ATTRIBUTE__ATTRIBUTE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QrmmPackage.Literals.ATTRIBUTE__REF_SEMANTIC,
				 QrmmFactory.eINSTANCE.createRefSemantic()));

		newChildDescriptors.add
			(createChildParameter
				(QrmmPackage.Literals.ATTRIBUTE__CONSTRAINT,
				 QrmmFactory.eINSTANCE.createAttributeValueRequirement()));

		newChildDescriptors.add
			(createChildParameter
				(QrmmPackage.Literals.ATTRIBUTE__ATTRIBUTE,
