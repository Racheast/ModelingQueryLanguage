...
/**
 * This is the item provider adapter for a {@link qrmm.RoleClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleClassItemProvider extends CAEXObjectItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.ROLE_CLASS__REF_BASE_CLASS_PATH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.ROLE_CLASS__BASE_CLASS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QrmmPackage.Literals.ROLE_CLASS__ATTRIBUTE);
			childrenFeatures.add(QrmmPackage.Literals.ROLE_CLASS__EXTERNAL_INTERFACE);
			childrenFeatures.add(QrmmPackage.Literals.ROLE_CLASS__ROLE_CLASS);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_RoleClass_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QrmmPackage.Literals.ROLE_CLASS__ATTRIBUTE,
		...
		newChildDescriptors.add
			(createChildParameter
				(QrmmPackage.Literals.ROLE_CLASS__EXTERNAL_INTERFACE,
				 QrmmFactory.eINSTANCE.createExternalInterface()));

		newChildDescriptors.add
			(createChildParameter
				(QrmmPackage.Literals.ROLE_CLASS__ROLE_CLASS,
				 QrmmFactory.eINSTANCE.createRoleClass()));

		newChildDescriptors.add
			(createChildParameter
				(QrmmPackage.Literals.ROLE_CLASS__ROLE_CLASS,
				 QrmmFactory.eINSTANCE.createRoleFamily()));
	}
