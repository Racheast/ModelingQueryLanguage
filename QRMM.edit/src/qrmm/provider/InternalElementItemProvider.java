...
/**
 * This is the item provider adapter for a {@link qrmm.InternalElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InternalElementItemProvider extends SystemUnitClassItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.INTERNAL_ELEMENT__REF_BASE_SYSTEM_UNIT_PATH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.INTERNAL_ELEMENT__BASE_SYSTEM_UNIT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QrmmPackage.Literals.INTERNAL_ELEMENT__ROLE_REQUIREMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QrmmPackage.Literals.INTERNAL_ELEMENT__ROLE_REQUIREMENTS,
				 QrmmFactory.eINSTANCE.createRoleRequirements()));
	}
