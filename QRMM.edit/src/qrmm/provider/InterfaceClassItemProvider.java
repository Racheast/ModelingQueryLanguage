...
/**
 * This is the item provider adapter for a {@link qrmm.InterfaceClass} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceClassItemProvider extends CAEXObjectItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.INTERFACE_CLASS__REF_BASE_CLASS_PATH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.INTERFACE_CLASS__BASE_CLASS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QrmmPackage.Literals.INTERFACE_CLASS__ATTRIBUTE);
			childrenFeatures.add(QrmmPackage.Literals.INTERFACE_CLASS__INTERFACE_CLASS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QrmmPackage.Literals.INTERFACE_CLASS__ATTRIBUTE,
		...
		newChildDescriptors.add
			(createChildParameter
				(QrmmPackage.Literals.INTERFACE_CLASS__INTERFACE_CLASS,
