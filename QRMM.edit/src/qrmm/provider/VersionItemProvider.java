...
/**
 * This is the item provider adapter for a {@link qrmm.Version} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VersionItemProvider extends SearchableElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Version_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Version_value_feature", "_UI_Version_type"),
				 QrmmPackage.Literals.VERSION__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addChangeModePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Version_changeMode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Version_changeMode_feature", "_UI_Version_type"),
				 QrmmPackage.Literals.VERSION__CHANGE_MODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Version)object).getValue();
