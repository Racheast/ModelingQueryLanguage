...
/**
 * This is the item provider adapter for a {@link qrmm.AttributeValueRequirement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeValueRequirementItemProvider extends CAEXBasicObjectItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.ATTRIBUTE_VALUE_REQUIREMENT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QrmmPackage.Literals.ATTRIBUTE_VALUE_REQUIREMENT__ORDINAL_SCALED_TYPE);
			childrenFeatures.add(QrmmPackage.Literals.ATTRIBUTE_VALUE_REQUIREMENT__NOMINAL_SCALED_TYPE);
			childrenFeatures.add(QrmmPackage.Literals.ATTRIBUTE_VALUE_REQUIREMENT__UNKNOWN_TYPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(QrmmPackage.Literals.ATTRIBUTE_VALUE_REQUIREMENT__ORDINAL_SCALED_TYPE,
				 QrmmFactory.eINSTANCE.createOrdinalScaledType()));

		newChildDescriptors.add
			(createChildParameter
				(QrmmPackage.Literals.ATTRIBUTE_VALUE_REQUIREMENT__NOMINAL_SCALED_TYPE,
				 QrmmFactory.eINSTANCE.createNominalScaledType()));

		newChildDescriptors.add
			(createChildParameter
				(QrmmPackage.Literals.ATTRIBUTE_VALUE_REQUIREMENT__UNKNOWN_TYPE,
				 QrmmFactory.eINSTANCE.createUnknownType()));
	}
