...
/**
 * This is the item provider adapter for a {@link qrmm.InterfaceIDMapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.INTERFACE_ID_MAPPING__ROLE_INTERFACE_ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.INTERFACE_ID_MAPPING__SYSTEM_UNIT_INTERFACE_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.INTERFACE_ID_MAPPING__ROLE_INTERFACE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QrmmPackage.Literals.INTERFACE_ID_MAPPING__SYSTEM_UNIT_INTERFACE,
				 true,
				 false,
				 true,
				 null,
