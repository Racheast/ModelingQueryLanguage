 ...
 * </p>
 * <ul>
 *   <li>{@link qrmm.impl.RevisionImpl#getRevisionDate <em>Revision Date</em>}</li>
 *   <li>{@link qrmm.impl.RevisionImpl#getOldVersion <em>Old Version</em>}</li>
 *   <li>{@link qrmm.impl.RevisionImpl#getNewVersion <em>New Version</em>}</li>
 *   <li>{@link qrmm.impl.RevisionImpl#getAuthorName <em>Author Name</em>}</li>
 *   <li>{@link qrmm.impl.RevisionImpl#getComment <em>Comment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RevisionImpl extends CAEXBasicObjectImpl implements Revision {
	...
	protected EClass eStaticClass() {
		return QrmmPackage.Literals.REVISION;
	}
	...
	public void setRevisionDate(XMLGregorianCalendar newRevisionDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QrmmPackage.REVISION__REVISION_DATE, oldRevisionDate, revisionDate));
	}
	...
	public void setOldVersion(String newOldVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QrmmPackage.REVISION__OLD_VERSION, oldOldVersion, oldVersion));
	}
	...
	public void setNewVersion(String newNewVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QrmmPackage.REVISION__NEW_VERSION, oldNewVersion, newVersion));
	}
	...
	public void setAuthorName(String newAuthorName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QrmmPackage.REVISION__AUTHOR_NAME, oldAuthorName, authorName));
	}
	...
	public void setComment(String newComment) {
		...
		comment = newComment;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QrmmPackage.REVISION__COMMENT, oldComment, comment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QrmmPackage.REVISION__REVISION_DATE:
				return getRevisionDate();
			case QrmmPackage.REVISION__OLD_VERSION:
				return getOldVersion();
			case QrmmPackage.REVISION__NEW_VERSION:
				return getNewVersion();
			case QrmmPackage.REVISION__AUTHOR_NAME:
				return getAuthorName();
			case QrmmPackage.REVISION__COMMENT:
				return getComment();
		}
