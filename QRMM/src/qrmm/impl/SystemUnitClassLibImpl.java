 ...
 * </p>
 * <ul>
 *   <li>{@link qrmm.impl.SystemUnitClassLibImpl#getSystemUnitClass <em>System Unit Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemUnitClassLibImpl extends CAEXObjectImpl implements SystemUnitClassLib {
	...
	protected EClass eStaticClass() {
		return QrmmPackage.Literals.SYSTEM_UNIT_CLASS_LIB;
	}
	...
	public EList<SystemUnitClass> getSystemUnitClass() {
		if (systemUnitClass == null) {
			systemUnitClass = new EObjectContainmentEList<SystemUnitClass>(SystemUnitClass.class, this, QrmmPackage.SYSTEM_UNIT_CLASS_LIB__SYSTEM_UNIT_CLASS);
		}
