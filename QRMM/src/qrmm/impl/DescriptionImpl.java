 ...
 * </p>
 * <ul>
 *   <li>{@link qrmm.impl.DescriptionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link qrmm.impl.DescriptionImpl#getChangeMode <em>Change Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DescriptionImpl extends SearchableElementImpl implements Description {
	/**
	...
	protected EClass eStaticClass() {
		return QrmmPackage.Literals.DESCRIPTION;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QrmmPackage.DESCRIPTION__VALUE, oldValue, value));
	}
	...
	public void setChangeMode(ChangeMode newChangeMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QrmmPackage.DESCRIPTION__CHANGE_MODE, oldChangeMode, changeMode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QrmmPackage.DESCRIPTION__VALUE:
				return getValue();
			case QrmmPackage.DESCRIPTION__CHANGE_MODE:
