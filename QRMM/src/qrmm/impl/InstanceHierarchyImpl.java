 ...
 * </p>
 * <ul>
 *   <li>{@link qrmm.impl.InstanceHierarchyImpl#getInternalElement <em>Internal Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstanceHierarchyImpl extends CAEXObjectImpl implements InstanceHierarchy {
	...
	protected EClass eStaticClass() {
		return QrmmPackage.Literals.INSTANCE_HIERARCHY;
	}
	...
	public EList<InternalElement> getInternalElement() {
		if (internalElement == null) {
			internalElement = new EObjectContainmentEList<InternalElement>(InternalElement.class, this, QrmmPackage.INSTANCE_HIERARCHY__INTERNAL_ELEMENT);
		}
