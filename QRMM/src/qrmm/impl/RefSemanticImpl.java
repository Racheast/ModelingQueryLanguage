 ...
 * </p>
 * <ul>
 *   <li>{@link qrmm.impl.RefSemanticImpl#getCorrespondingAttributePath <em>Corresponding Attribute Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RefSemanticImpl extends CAEXBasicObjectImpl implements RefSemantic {
	...
	protected EClass eStaticClass() {
		return QrmmPackage.Literals.REF_SEMANTIC;
	}
	...
	public void setCorrespondingAttributePath(String newCorrespondingAttributePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QrmmPackage.REF_SEMANTIC__CORRESPONDING_ATTRIBUTE_PATH, oldCorrespondingAttributePath, correspondingAttributePath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QrmmPackage.REF_SEMANTIC__CORRESPONDING_ATTRIBUTE_PATH:
