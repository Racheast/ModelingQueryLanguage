 ...
 * </p>
 * <ul>
 *   <li>{@link qrmm.impl.OrdinalScaledTypeImpl#getRequiredMaxValue <em>Required Max Value</em>}</li>
 *   <li>{@link qrmm.impl.OrdinalScaledTypeImpl#getRequiredValue <em>Required Value</em>}</li>
 *   <li>{@link qrmm.impl.OrdinalScaledTypeImpl#getRequiredMinValue <em>Required Min Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrdinalScaledTypeImpl extends SearchableElementImpl implements OrdinalScaledType {
	/**
	...
	protected EClass eStaticClass() {
		return QrmmPackage.Literals.ORDINAL_SCALED_TYPE;
	}
	...
	public void setRequiredMaxValue(String newRequiredMaxValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QrmmPackage.ORDINAL_SCALED_TYPE__REQUIRED_MAX_VALUE, oldRequiredMaxValue, requiredMaxValue));
	}
	...
	public void setRequiredValue(String newRequiredValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QrmmPackage.ORDINAL_SCALED_TYPE__REQUIRED_VALUE, oldRequiredValue, requiredValue));
	}
	...
	public void setRequiredMinValue(String newRequiredMinValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QrmmPackage.ORDINAL_SCALED_TYPE__REQUIRED_MIN_VALUE, oldRequiredMinValue, requiredMinValue));
	}
