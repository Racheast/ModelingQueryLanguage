 ...
 * </p>
 * <ul>
 *   <li>{@link qrmm.impl.RoleClassLibImpl#getRoleClass <em>Role Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoleClassLibImpl extends CAEXObjectImpl implements RoleClassLib {
	...
	protected EClass eStaticClass() {
		return QrmmPackage.Literals.ROLE_CLASS_LIB;
	}
	...
	public EList<RoleClass> getRoleClass() {
		if (roleClass == null) {
			roleClass = new EObjectContainmentEList<RoleClass>(RoleClass.class, this, QrmmPackage.ROLE_CLASS_LIB__ROLE_CLASS);
		}
		return roleClass;
	}
