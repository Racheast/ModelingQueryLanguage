 ...
 * </p>
 * <ul>
 *   <li>{@link qrmm.impl.SystemUnitClassImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link qrmm.impl.SystemUnitClassImpl#getExternalInterface <em>External Interface</em>}</li>
 *   <li>{@link qrmm.impl.SystemUnitClassImpl#getInternalElement <em>Internal Element</em>}</li>
 *   <li>{@link qrmm.impl.SystemUnitClassImpl#getSupportedRoleClass <em>Supported Role Class</em>}</li>
 *   <li>{@link qrmm.impl.SystemUnitClassImpl#getInternalLink <em>Internal Link</em>}</li>
 *   <li>{@link qrmm.impl.SystemUnitClassImpl#getBaseClass <em>Base Class</em>}</li>
 *   <li>{@link qrmm.impl.SystemUnitClassImpl#getSystemUnitClass <em>System Unit Class</em>}</li>
 *   <li>{@link qrmm.impl.SystemUnitClassImpl#getRefBaseClassPath <em>Ref Base Class Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemUnitClassImpl extends CAEXObjectImpl implements SystemUnitClass {
	...
	protected EClass eStaticClass() {
		return QrmmPackage.Literals.SYSTEM_UNIT_CLASS;
	}
	...
	public EList<Attribute> getAttribute() {
		if (attribute == null) {
			attribute = new EObjectContainmentEList<Attribute>(Attribute.class, this, QrmmPackage.SYSTEM_UNIT_CLASS__ATTRIBUTE);
		}
		return attribute;
	}
	...
	public EList<InterfaceClass> getExternalInterface() {
		if (externalInterface == null) {
			externalInterface = new EObjectContainmentEList<InterfaceClass>(InterfaceClass.class, this, QrmmPackage.SYSTEM_UNIT_CLASS__EXTERNAL_INTERFACE);
		}
	...
	public EList<InternalElement> getInternalElement() {
		if (internalElement == null) {
			internalElement = new EObjectContainmentEList<InternalElement>(InternalElement.class, this, QrmmPackage.SYSTEM_UNIT_CLASS__INTERNAL_ELEMENT);
		}
	...
	public EList<SupportedRoleClass> getSupportedRoleClass() {
		if (supportedRoleClass == null) {
			supportedRoleClass = new EObjectContainmentEList<SupportedRoleClass>(SupportedRoleClass.class, this, QrmmPackage.SYSTEM_UNIT_CLASS__SUPPORTED_ROLE_CLASS);
		}
	...
	public EList<InternalLink> getInternalLink() {
		if (internalLink == null) {
			internalLink = new EObjectContainmentEList<InternalLink>(InternalLink.class, this, QrmmPackage.SYSTEM_UNIT_CLASS__INTERNAL_LINK);
		}
		return internalLink;
	}
		...
		if (baseClass != null && baseClass.eIsProxy()) {
			...
			if (baseClass != oldBaseClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, QrmmPackage.SYSTEM_UNIT_CLASS__BASE_CLASS, oldBaseClass, baseClass));
			}
		}
		return baseClass;
	}
	...
	public void setBaseClass(SystemUnitClass newBaseClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QrmmPackage.SYSTEM_UNIT_CLASS__BASE_CLASS, oldBaseClass, baseClass));
	}
	...
	public EList<SystemUnitClass> getSystemUnitClass() {
		if (systemUnitClass == null) {
			systemUnitClass = new EObjectContainmentEList<SystemUnitClass>(SystemUnitClass.class, this, QrmmPackage.SYSTEM_UNIT_CLASS__SYSTEM_UNIT_CLASS);
		}
	...
	public void setRefBaseClassPath(String newRefBaseClassPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QrmmPackage.SYSTEM_UNIT_CLASS__REF_BASE_CLASS_PATH, oldRefBaseClassPath, refBaseClassPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case QrmmPackage.SYSTEM_UNIT_CLASS__BASE_CLASS:
